...
/* Recibe una funcion para comparar claves entre si, una funcion para destruir datos
...
/* Recibe el abb, una clave y un dato. Guarda la clave asociada al dato o remplaza
el dato si la clave ya se encuentra en el abb. Devuelve false en caso de erro
Pre: Se creo el abb
...
/* Recibe el iterador y lo avanza un elemento, devolviendo true si se avanzo,
